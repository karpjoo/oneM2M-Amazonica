...
async function test() {
    try {
        var sae_rsr = await sae_sys.restart([[svc_id1, eServ1],[svc_id2, eServ2]]);

        // console.log('\n\n----- after SAEsys.initialize -----\n', JSON.stringify(sae_rsr, null, 2));
        console.log('\n\n----- after SAEsys.restart -----\n');
        ...
        var res1 = await sae_sys.publish_Request('wdc_base/' + svc_id1, "Hello, ELSIO", callback_func);
        ...
        var res2 = await sae_sys.publish_Event(ee_id1, 'Hi, eServ2');
